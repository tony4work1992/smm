export class ThemeStyles {
    public static BACKGROUND_LEVEL_1 = '#002f4d';
    public static BACKGROUND_LEVEL_2 = '#003d63';
    public static BACKGROUND_LEVEL_3 = '#004f80';
    public static BACKGROUND_LEVEL_4 = '#005e99';
    public static BACKGROUND_LEVEL_5 = '#006eb3';

    public static TEXT_COLOR_LEVEL_1 = 'whitesmoke';
