...
const FieldPathMolecule: React.FC<IFieldPathMapperProps> = (props) => {
  return (
    ...
    <Row justify="space-between" style={{ width: "100%", position: "relative" }}>
      <Col span={2} style={{ height: 25 }}><LineNo {...props} /></Col>
      <Col span={9}><PathSelectAtom {...props["fromModel"]} /></Col>
      <Col span={9}><PathSelectAtom {...props["toModel"]} /></Col>
      {props.isSelecting && <Col span={2}><DeleteButton delete={props.delete} /></Col>}
    </Row>
